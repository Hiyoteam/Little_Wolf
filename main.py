...
def main(socket,channel):
	...
	# 剧情词组:通用
	general=[["选择","决定","打算","想要"],["断了气","没了动静","停了心跳","一命呜呼"],["深夜","半夜三更","凌晨两点","午夜时分"],["失去理智","愤愤不平","闹腾","愤怒"],["绿色","白色","翻折","皱巴巴","缺了角","整齐叠好"],["收回伸出纸片的手","不知如何抉择","有些迷茫","仔细思考"],["误入","闯入","跳进","来到"],["欺负","诅咒","戏弄","鞭尸"],["飘走了","被偷走了","被捡走了","不翼而飞"]]
